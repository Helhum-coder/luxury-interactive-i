...
import { GitHubRepository, GitHubBranch, GitHubCommit, GitHubUser } from '@/lib/types'
                  ...
                  {filteredRepos.map((repo, idx) => (
                    ...
                    >
                      <button
                        ...
                        className="w-full p-3 bg-muted/20 border border-border/30 rounded-lg hover:bg-muted/40 hover:border-accent/50 transition-all text-left"
                      >
